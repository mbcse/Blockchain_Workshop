...
App = {
  ...
  loadContract: async () => {
    ...
    let address = "0x009587C433779F705dCc860C7f07b8C56eCF9E7e";

    App.todoList = new web3.eth.Contract(abi, address);
    console.log(App.todoList);
    App.todoList.methods.taskCount().call();
  },
  ...
  createTask: async () => {
    ...
    App.todoList.methods
      .createTask(content)
      .send({ from: web3.currentProvider.selectedAddress }, (err, tx) => {
        console.log(tx);
      })
      .on("confirmation", (cn, tt) => {
        console.log(cn);
      })
      .on("receipt", (rc) => {
        console.log(rc);
